...
echo "\e[32m================================================================="
echo "\e[32m-----------------------------------------------------------------"
echo "\e[32m> > > > > Install PHP (https://packages.sury.org/php/) =====>>>>> version"
read -p "Enter version=" phpversion

echo "\e[32m-----------------------------------------------------------------"
echo "\e[32m> > > > > Install PHP (https://packages.sury.org/php/) =====>>>>> update && upgrade:"
sudo apt update && upgrade

echo "\e[32m-----------------------------------------------------------------"
echo "\e[32m> > > > > Install PHP (https://packages.sury.org/php/) =====>>>>> add repository"
...
echo "\e[32m-----------------------------------------------------------------"
echo "\e[32m> > > > > Install PHP (https://packages.sury.org/php/) =====>>>>> update"
sudo apt update

echo "\e[32m-----------------------------------------------------------------"
echo "\e[32m> > > > > Install PHP (https://packages.sury.org/php/) =====>>>>> Install"
